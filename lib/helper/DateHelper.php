...
function format_daterange($start_date, $end_date, ?string $format, $full_text, $start_text, $end_text, $culture = null, $charset = null)
{
    if (\is_null($format)) {
        $format = 'd';
    }
...
{
    return \distance_of_time_in_words($from_time, \time(), $include_seconds);
}
